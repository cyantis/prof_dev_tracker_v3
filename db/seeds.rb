...
Employee.create({ username: "cody", password: "12345", email: "cody@fakestartup.com", name: "Cody Yantis", title: "Aspiring Developer", bio: "software engineering student at @flatiron-school. formerly of the @ctcidealab. also: sound maker. picture taker. yoga teacher. writing instructor. librarian.", location_id: 2, manager_id:  1})
